...
SUITES = ["tests.smoke_kernel", "tests.smoke_param", "tests.smoke_asm",
          ...
          "tests.smoke_no_raw_leak", "tests.smoke_import_step",
          "tests.smoke_ss_guards", "tests.smoke_surface",
          "tests.smoke_resource", "tests.smoke_planner",
          "tests.smoke_fusion_pipeline", "tests.smoke_project",
          "tests.smoke_assembly_project", "tests.smoke_recipes",
          ...
          "tests.smoke_bop", "tests.smoke_percept", "tests.smoke_aiide",
          "tests.smoke_projstate", "tests.smoke_api", "tests.smoke_panel"]
